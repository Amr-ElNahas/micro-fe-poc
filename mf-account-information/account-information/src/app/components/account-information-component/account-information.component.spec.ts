  ...
  describe('LoginComponent', () => {
    ...
    beforeEach(() => {
      ...
      fakeAuthService = jasmine.createSpyObj(
        "AuthenticationService", ["getUserName", "isSupervisor","isEmployee","getRole"]
      );
      TestBed.configureTestingModule({
        ...
        providers: [
          ...
          {provide:window, useValue:{
            localStorage:{
              getItem:(user:string)=>{return JSON.stringify({
                userName:""
              })},
    ...
    it('can load instance', () => {
      ...
      it(`should render information card`, () => {
        expect(
          fixture.debugElement.query(By.css('#informationcard'))
        ).toBeTruthy();
      });
      ...
      it(`should render account number`, () => {
        ...
        expect(
          fixture.debugElement.query(By.css('#informationaccountnumber')).nativeElement
        ).toBeTruthy();
      });
